    ...
    <div className="relative min-h-screen bg-[#111] text-[#D1D1CB] font-sans selection:bg-white selection:text-black">
      ...
      <div className="relative min-h-screen flex flex-col overflow-hidden text-white selection:bg-white selection:text-black">
        ...
        <div className="absolute inset-0 z-0 bg-[#111]">
          <img src="/images/20260727_223746.jpg" alt="Dhruv Background 1" className={`absolute inset-0 w-full h-full object-cover object-[25%_45%] scale-[1.15] grayscale transition-opacity duration-1000 ease-in-out ${currentImage === 0 ? 'opacity-100' : 'opacity-0'}`} />
          <img src="/images/2.jpg" alt="Dhruv Background 2" className={`absolute inset-0 w-full h-full object-cover object-[25%_45%] scale-[1.15] grayscale transition-opacity duration-1000 ease-in-out ${currentImage === 1 ? 'opacity-100' : 'opacity-0'}`} />
            ...
            <div className="mx-auto w-full max-w-4xl py-6 md:py-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-0 text-sm font-semibold tracking-tight">
              <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-8 lg:gap-12 w-full md:w-auto">
                ...
                <div className="flex flex-wrap items-center gap-4 md:gap-6 text-xs md:text-sm font-semibold text-white/60">
                  ...
                  <Link to="/client-projects" className="hover:opacity-60 hover:text-white transition">Client Projects</Link>
